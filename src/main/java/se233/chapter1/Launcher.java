...
public class Launcher extends Application {
    ...
    public static ArrayList<BasedEquipment> getAllEquipments() { // แก้ไขข้อผิดพลาดจาก image_bf8839.png
    ...
    public static Weapon getEquippedWeapon() { // แก้ไขข้อผิดพลาดจาก image_bf1795.png
    ...
    public static Armor getEquippedArmor() { // แก้ไขข้อผิดพลาดจาก image_beb57f.png
